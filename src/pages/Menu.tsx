...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    category: 'Snacks',
    name: 'Veg Roll',
    description: 'A soft wrap filled with spiced vegetables, rolled up for a flavorful.',
    price: 20,
  ...
  },
  {
    ...
    name: 'Black Forest',
    description: 'A rich, moist chocolate cake layered with whipped cream.',
    price: 390,
  ...
  },
  {
    ...
    category: 'Tea and Coffee',
    name: 'Cold COffee',
    description: 'A chilled coffee beverage blended with ice, milk, and sugar.',
    price: 50,
  ...
  },
  {
    ...
    description: 'A rich, decadent cake made with smooth chocolate ganache.',
    price: 500,
  ...
  },
  {
    ...
    category: 'Birthday Cakes',
    name: 'Pineapple Cake',
    description: 'A moist cake flavored with fresh pineapple, often topped with pineapple chunks.',
    price: 450,
  ...
  },
  {
    ...
    category: 'Snacks',
    name: 'Onion Pakoda',
    description: 'Crispy fritters made with sliced onions, chickpea flour, and spices, deep-fried to perfection.',
    price: 10,
  ...
  },
  {
    ...
    category: 'Lunch',
    name: 'Curd Rice',
    description: 'A simple and soothing dish made with rice and yogurt.',
    price: 40,
  ...
  },
  {
    ...
    category: 'Snacks',
    name: 'Bread Omelette',
    description: 'Bread omelette is a simple dish made by cooking an omelette with bread slices, often served as a quick and filling snack or breakfast.',
    price: 40,
  ...
  },
  {
    ...
    category: 'Breakfast',
    name: 'Aapam',
    description: 'Aapam is a soft, fluffy, and mildly tangy pancake made from fermented rice and coconut batter, typically served with stew or curry.',
    price: 50,
  ...
  },
  {
    ...
    category: 'Breakfast',
    name: 'Idiyappam',
    description: 'Idiyappam is a soft, steamed rice noodle dish, typically served with curry or coconut milk in South Indian cuisine.',
    price: 40,
  ...
  },
  {
    ...
    description: 'Onion Oothappam is a thick, savory South Indian pancake topped with sautéed onions and spices, usually served with chutneys and sambar.',
    price: 40,
  ...
  },
  {
    ...
    category: 'Breakfast',
    name: 'Ghee Roast',
    description: 'Ghee roast is a flavorful South Indian dish made by roasting crispy dosas with ghee, often served with chutneys and sambar.',
    price: 45,
  ...
  },
  {
    ...
    category: 'Breakfast',
    name: 'Neer Dosa',
    description: 'Neer Dosa is a soft, thin, and delicate rice pancake from South India, typically served with coconut chutney or curry.',
    price: 45,
  ...
  },
  {
    ...
    category: 'Breakfast',
    name: 'Podi Idly',
    description: 'Podi Idly is a popular South Indian dish where steamed idlis are coated with a spicy, flavorful powder made from lentils and spices.',
    price: 45,
